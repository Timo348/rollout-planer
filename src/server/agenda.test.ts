...
function appointment(overrides: Partial<Appointment> = {}): Appointment {
  return {
    ...
    startTime: "08:00",
    endTime: "09:00",
    name: "Organisation A, Filiale; Süd",
...
describe("Tagesagenda", () => {
  it("baut eine iCal-Einladung mit einem VEVENT pro Termin", () => {
    ...
    expect(ics).toContain("SUMMARY:Organisation A\\, Filiale\\; Süd");
  ...
  it("formuliert Betreff und Text auf Deutsch", () => {
    expect(buildAppointmentSubject("2026-07-20", appointment())).toBe(
      "Rollout-Termin am 20.07.2026, 08:00–09:00 Uhr: Organisation A, Filiale; Süd",
    );
    ...
    expect(text).toContain("- 08:00–09:00 Uhr: Organisation A, Filiale; Süd");
